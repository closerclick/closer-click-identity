/**
 * Closer Click Identity — adaptador headless para Node.js.
 *
...
const DEFAULT_DIR = path.join(os.homedir(), '.closer-click', 'identity')

export class Identity {
  /**
   * @param {Object} [options]
   * @param {string} [options.dir]  Directorio de persistencia de esta identidad.
   *   Cada directorio = un usuario distinto. Default: ~/.closer-click/identity
   */
  constructor (options = {}) {
